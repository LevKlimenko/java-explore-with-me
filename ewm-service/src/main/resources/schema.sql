DROP TABLE IF EXIST users,categories,events,requests,compilations,comp-event;
...
(
    ...
    CONSTRAINT email_at CHECK
(
    email LIKE '%@%'
),
    CONSTRAINT space_name_user CHECK
(
...
(
    ...
    CONSTRAINT space_name_categories CHECK
(
    name NOT LIKE ' ' and name NOT LIKE ''
)
    );
...
(
    ...
    comp_id BIGINT REFERENCES compilations
(
    id
)
  ON DELETE CASCADE,
